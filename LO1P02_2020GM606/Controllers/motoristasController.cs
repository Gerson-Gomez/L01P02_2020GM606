...
using LO1P02_2020GM606.Models;

namespace LO1P02_2020GM606.Controllers
{
    public class motoristasController : Controller
    {
        private readonly restaurantDbContext _context;

        public motoristasController(restaurantDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.motoristas != null ? 
                          ...
                          Problem("Entity set 'restaurantDbContext.motoristas'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'restaurantDbContext.motoristas'  is null.");
            }
            var motoristas = await _context.motoristas.FindAsync(id);
            if (motoristas != null)
            {
